local theme = require "nvim-mariana.theme"
...
local DEFAULT = {
	...
	colors = {
		...
		bg3 = "#2e353e",
		bg4 = "#4b5864",
		fg1 = "#d9d9d9", -- override white from orig with text_fg
		fg2 = "#d8dee9",
		fg3 = "#a6acb8",
		fg4 = "#46525c",
		shade1 = "#2f373f",
...
function M:get_colors() return self.config.colors end

return {
	--- loads the colorscheme
	---@return nil
	load = function() M:load(theme) end,
	colors = function() return M:get_colors() end,
	---@param config Configuration
	setup = function(config) M:setup(config) end,
}
